...
This tutorial will only give a few examples of how *OpenMM* and *Biotite* can interact.

First example: MD simulation of lysozyme
----------------------------------------
Here the aim is run the prominent
`'Lysozyme in water' <http://www.mdtutorials.com/gmx/lysozyme/>`_ example in *OpenMM*.
For structure preparation and analysis afterwards, we will use *Biotite*.
...
.. jupyter-execute::
    ...
    pymol_interface.play((1500, 1500), format="mp4")
