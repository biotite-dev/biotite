...
The function starts by building a '*zigzag*' backbone containing ``N``,
``CA`` and ``C`` atoms based on bond geometry.
...
the backbone in the right orientation via superimposition.
"""
