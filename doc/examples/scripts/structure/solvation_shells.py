...
templ_file_path = "../../../static/assets/download/waterbox_gmx_md.pdb"
traj_file_path  = "../../../static/assets/download/waterbox_gmx_md.xtc"
...
# and requires a bit trial and error on the parameters
