...
class GROFile(TextFile):
    ...
    def get_structure(self, model=None):
        ...
        if isinstance(array, AtomArray):
            ...
            box_i = atom_i[-1] + 1
            box_param = [float(e)*10 for e in self._lines[box_i].split()]
    ...
    def set_structure(self, array):
        ...
        if isinstance(array, AtomArray):
            ...
            # Write header lines
            self._lines[0] = f"Generated by Biotite at {datetime.now()}"
            ...
            # Write box lines
            self._lines[-1] = get_box_dimen(array)
        elif isinstance(array, AtomArrayStack):
            self._lines = []
            ...
            for i in range(array.stack_depth()):
                ...
                self._lines.append(get_box_dimen(array[i]))
        else:
