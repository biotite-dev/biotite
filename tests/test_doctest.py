...
@pytest.mark.parametrize("package_name, context_package_names", [
    ...
    pytest.param("biotite.application.mafft",   ["biotite.sequence"],
                 marks=pytest.mark.skipif(is_not_installed("mafft"),
                                          reason="Software is not installed")),
    pytest.param("biotite.application.sra",     ["biotite.sequence"],
                 marks=pytest.mark.skipif(is_not_installed("fasterq-dump"),
                                          reason="Software is not installed")),
    pytest.param("biotite.application.tantan",  ["biotite.sequence"],
                 marks=pytest.mark.skipif(is_not_installed("tantan"),
                                          reason="Software is not installed")),
    pytest.param("biotite.application.viennarna", ["biotite.structure"],
                 marks=pytest.mark.skipif(is_not_installed("RNAfold") | is_not_installed("RNAplot"),
                                          reason="Software is not installed")),                                      
