...
import mdtraj
from biotite.structure.info.radii import _SINGLE_ATOM_VDW_RADII as SINGLE_RADII
...
def compute_mdtraj_sasa(pdb_path):
    ...
    radii = {
        element.capitalize(): radius / 10.0 for element, radius in SINGLE_RADII.items()
    }
